...
try {
    ...
    const dirCmd = `ssh -i C:\\Users\\deba_pc.com\\.ssh\\iptv_rsa -o StrictHostKeyChecking=no ubuntu@35.174.78.33 "ls -la"`;
    ...
    const deployCmd = `ssh -i C:\\Users\\deba_pc.com\\.ssh\\iptv_rsa -o StrictHostKeyChecking=no ubuntu@35.174.78.33 "cd ~/${projectDir} && git pull origin main && cd backend && npm install && cd ../frontend && npm install && npm run build && pm2 restart all"`;
