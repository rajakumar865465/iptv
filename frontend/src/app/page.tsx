    ...
    <div className="min-h-screen bg-[#0a0a0c] text-white overflow-x-hidden">
      ...
      <main>
                ...
                .map(cat => {
                  ...
                  return (
                    <Link
                      ...
                      key={cat.id}
                      className="group p-3 sm:p-4 rounded-xl bg-white/5 border border-white/10 hover:border-red-500/30 hover:bg-red-500/5 transition-all"
                    >
                      ...
                      <h3 className="font-semibold text-white text-xs sm:text-sm mb-1 group-hover:text-red-400 transition-colors truncate">{cat.name}</h3>
        ...
        <section className="py-10 sm:py-16 md:py-24 bg-white/[0.02]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white mb-2 sm:mb-4">Why Choose IPTVLive?</h2>
              <p className="text-slate-400 text-sm sm:text-lg max-w-2xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                <div key={i} className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 hover:border-red-500/20 transition-colors">
                  <item.icon className="w-7 h-7 sm:w-8 sm:h-8 text-red-400 mb-3 sm:mb-4" />
              ...
              {HOW_IT_WORKS.map((step, i) => (
                <div key={i} className="flex gap-4 sm:gap-6 mb-6 sm:mb-8 last:mb-0">
                  <div className="flex flex-col items-center">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-red-600 flex items-center justify-center text-white font-bold text-xs sm:text-sm shrink-0">
                      {step.step}
                    </div>
        ...
        <section className="py-10 sm:py-16 md:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <Link
                href="/pricing"
                className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl bg-red-600 hover:bg-red-500 text-white font-bold text-base sm:text-lg transition-colors min-h-[44px]"
              >
                <Key className="w-4 h-4 sm:w-5 sm:h-5" /> Buy License
              </Link>
              <Link
