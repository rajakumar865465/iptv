...
export default function PrivacyPage() {
  ...
  return (
    <div className="pt-24 pb-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto text-white/90">
      ...
      <div className="border-b border-white/10 pb-8 mb-10">
        ...
        <div className="flex flex-wrap items-center gap-4 text-xs sm:text-sm text-white/80">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-white/90 font-medium">
            <span className="w-2 h-2 rounded-full bg-emerald-400" />
            Effective: August 20, 2026
          </span>
          <span className="text-white/70">Jurisdiction: Tripura, India</span>
          <span className="text-white/70">•</span>
          <span className="text-white/70">Version 2.8</span>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <nav className="space-y-1">
              {SECTIONS.map((sec) => (
                ...
                >
                  ...
                  <ChevronRight className="w-3.5 h-3.5 text-white/50 group-hover:text-indigo-400 transition-colors" />
                </a>
              ))}
            </nav>

            <div className="mt-6 pt-5 border-t border-white/10">
              <p className="text-xs text-white/70 mb-2">Need legal or DMCA assistance?</p>
              <a
        ...
        <main className="lg:col-span-8 space-y-8">
          ...
          <section id="collection" className="bg-[#121218] border border-white/10 rounded-2xl p-6 sm:p-8 scroll-mt-28">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-white/90">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-white/90 ml-2">
                  <li>Full name</li>
                  <li>Email address</li>
          ...
          <section id="usage" className="bg-[#121218] border border-white/10 rounded-2xl p-6 sm:p-8 scroll-mt-28">
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-white/90 mb-6">
              <li>
          ...
          <section id="retention" className="bg-[#121218] border border-white/10 rounded-2xl p-6 sm:p-8 scroll-mt-28">
            ...
            <ul className="space-y-1.5 text-xs sm:text-sm text-white/90 mb-4">
          ...
          <section id="rights" className="bg-[#121218] border border-white/10 rounded-2xl p-6 sm:p-8 scroll-mt-28">
            ...
            <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-xl p-4 text-xs sm:text-sm text-white/90">
          ...
          <section id="dmca" className="bg-[#121218] border border-white/10 rounded-2xl p-6 sm:p-8 scroll-mt-28">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs sm:text-sm">
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <span className="text-white/70 block mb-1">Official Legal Email</span>
                <a
                  href="mailto:support@nivatv.luxomall.in"
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <span className="text-white/70 block mb-1">Support Portal</span>
                <Link
                  href="/support"
