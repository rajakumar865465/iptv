  ...
  return (
    <div className="pt-32 pb-20 px-4">
      <div className="max-w-md mx-auto text-center">
        ...
        <p className="text-slate-400 mb-2">Your payment was not completed successfully.</p>
        <p className="text-slate-500 text-sm mb-10">
          No money has been deducted. If your account was charged, contact support with your transaction ID.
        </p>

        <div className="flex flex-col gap-3">
          <Link href="/pricing" className="flex items-center justify-center gap-2 py-3 rounded-xl bg-red-600 hover:bg-red-700 text-white font-semibold transition-colors">
            <RefreshCw className="w-4 h-4" /> Try Again
          </Link>
          <Link href="/support" className="flex items-center justify-center gap-2 py-3 rounded-xl bg-white/10 hover:bg-white/20 text-white font-semibold transition-colors border border-white/10">
