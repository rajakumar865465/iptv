          ...
          >
            ...
            {ch.live && (
              <div className="flex items-center gap-1">
                ...
                <span className="text-[8px] text-live font-medium">LIVE</span>
              </div>
            )}
          </div>
        ))}
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 relative">
        ...
        <div className="w-full mt-3 space-y-2">
          ...
          <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
            <div className="w-2/3 h-full bg-brand-500 rounded-full" />
          </div>
  ...
  return (
    <div className="flex flex-col h-full bg-surface">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5">
        <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-brand-500/20 to-brand-700/20 border border-brand-500/20 flex items-center justify-center mb-5">
        ...
        {/* Activate button */}
        <div className="w-full bg-brand-600 rounded-xl py-2.5 text-center mb-4">
  ...
  return (
    ...
    >
      <div className="relative">
        {/* Glow effect */}
        <div className="absolute -inset-2 bg-brand-600/0 rounded-[40px] blur-xl transition-all duration-500 group-hover:bg-brand-600/10" />
        {/* Phone frame */}
        <div className="relative w-[180px] sm:w-[200px] rounded-[32px] sm:rounded-[36px] bg-gradient-to-b from-[#2a2a2c] via-[#1e1e20] to-[#141416] border border-white/10 group-hover:border-brand-500/30 transition-colors duration-500 shadow-2xl shadow-black/50 p-[6px] sm:p-[7px] pb-2.5 sm:pb-3">
          {/* Notch */}
