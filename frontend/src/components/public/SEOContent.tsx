...
export default function SEOContent() {
  return (
    <section className="py-16 sm:py-24 md:py-28 bg-white/[0.02] border-t border-white/5">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-ink-muted text-base leading-relaxed space-y-8">
        ...
        <h3 className="text-xl font-bold text-white mt-8 mb-2">Which Channels Are Available?</h3>
        <p>
          ...
          <Link href="/browse" className="text-brand-400 hover:text-brand-300 underline underline-offset-2">full channel list</Link>{' '}
          is updated regularly as new streams are added.
        </p>

        <h3 className="text-xl font-bold text-white mt-8 mb-2">How Does the License Work?</h3>
        <p>
          Unlike cable TV, NivaTV uses a simple license key system. After you{' '}
          <Link href="/pricing" className="text-brand-400 hover:text-brand-300 underline underline-offset-2">choose a plan</Link>,
        ...
        <h3 className="text-xl font-bold text-white mt-8 mb-2">Watching IPL and Sports Live</h3>
        <p>
        ...
        <h3 className="text-xl font-bold text-white mt-8 mb-2">Is It Safe to Install?</h3>
        <p>
          ...
          <Link href="/download" className="text-brand-400 hover:text-brand-300 underline underline-offset-2">download page</Link>{' '}
          includes a step-by-step installation guide so you can set it up in under five minutes.
        </p>

        <h3 className="text-xl font-bold text-white mt-8 mb-2">NivaTV vs Cable TV vs OTT Platforms</h3>
        <p>
          ...
          <Link href="/support" className="text-brand-400 hover:text-brand-300 underline underline-offset-2">our support team</Link>{' '}
